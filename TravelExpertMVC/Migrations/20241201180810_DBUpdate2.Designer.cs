...
namespace TravelExpertMVC.Migrations
{
    ...
    [Migration("20241201180810_DBUpdate2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.Agency", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.Agent", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.Booking", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.BookingDetail", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.Class", b =>
                {
                    b.Property<string>("ClassId")
                        .HasMaxLength(5)
                        .HasColumnType("nvarchar(5)");
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.CreditCard", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.Customer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.CustomersReward", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.Employee", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.Fee", b =>
                {
                    b.Property<string>("FeeId")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.Package", b =>
                {
                    b.Property<int>("PackageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.PackagesProductsSupplier", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.ProductsSupplier", b =>
                {
                    b.Property<int>("ProductSupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.Region", b =>
                {
                    b.Property<string>("RegionId")
                        .HasMaxLength(5)
                        .HasColumnType("nvarchar(5)");
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.Reward", b =>
                {
                    b.Property<int>("RewardId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.SupplierContact", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.TripType", b =>
                {
                    b.Property<string>("TripTypeId")
                        .HasMaxLength(1)
                        .HasColumnType("nvarchar(1)");
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.Agent", b =>
                {
                    b.HasOne("TravelExpertMVC.Models.Agency", "Agency")
                        .WithMany("Agents")
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.Booking", b =>
                {
                    ...
                    b.HasOne("TravelExpertMVC.Models.Package", "Package")
                        .WithMany("Bookings")
                        .HasForeignKey("PackageId")
                        .HasConstraintName("Bookings_FK01");

                    b.HasOne("TravelExpertMVC.Models.TripType", "TripType")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.BookingDetail", b =>
                {
                    b.HasOne("TravelExpertMVC.Models.Booking", "Booking")
                        .WithMany("BookingDetails")
                        .HasForeignKey("BookingId")
                        .HasConstraintName("FK_BookingDetails_Bookings");

                    b.HasOne("TravelExpertMVC.Models.Class", "Class")
                        .WithMany("BookingDetails")
                        .HasForeignKey("ClassId")
                        .HasConstraintName("FK_BookingDetails_Classes");

                    b.HasOne("TravelExpertMVC.Models.Fee", "Fee")
                        .WithMany("BookingDetails")
                        .HasForeignKey("FeeId")
                        .HasConstraintName("FK_BookingDetails_Fees");

                    b.HasOne("TravelExpertMVC.Models.ProductsSupplier", "ProductSupplier")
                        .WithMany("BookingDetails")
                        .HasForeignKey("ProductSupplierId")
                        .HasConstraintName("FK_BookingDetails_Products_Suppliers");

                    b.HasOne("TravelExpertMVC.Models.Region", "Region")
                        .WithMany("BookingDetails")
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.Customer", b =>
                {
                    b.HasOne("TravelExpertMVC.Models.Agent", "Agent")
                        .WithMany("Customers")
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.CustomersReward", b =>
                {
                    ...
                    b.HasOne("TravelExpertMVC.Models.Reward", "Reward")
                        .WithMany("CustomersRewards")
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.ProductsSupplier", b =>
                {
                    b.HasOne("TravelExpertMVC.Models.Product", "Product")
                        .WithMany("ProductsSuppliers")
                        .HasForeignKey("ProductId")
                        .HasConstraintName("Products_Suppliers_FK00");

                    b.HasOne("TravelExpertMVC.Models.Supplier", "Supplier")
                        .WithMany("ProductsSuppliers")
            ...
            modelBuilder.Entity("TravelExpertMVC.Models.SupplierContact", b =>
                {
                    b.HasOne("TravelExpertMVC.Models.Affiliation", "Affiliation")
